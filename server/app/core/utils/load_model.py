...
def get_dense_model(model_path="/app/model/", token_level="word-level", device=None):
    ...
    if _dense_model is None:
        config = RobertaConfig.from_pretrained(model_path, finetuning_task=token_level, local_files_only=True)
        args = type("Args", (), {})()
        ...
        _dense_model = DenseEmbedding.from_pretrained(model_path, config=config, args=args, local_files_only=True)
